        ...
        <div className="flex flex-col md:flex-row -mx-4">
            <div className="md:flex-1 px-4">
                ...
                <div className="flex -mx-2 mb-4">
                    ...
                    <div className="w-1/2 px-2">
                        <button className="w-full bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-white py-2 px-4 rounded-full font-bold hover:bg-gray-300 dark:hover:bg-red-600">Delete</button>
                    </div>
                </div>
            </div>
            <div className="md:flex-1 px-4">
